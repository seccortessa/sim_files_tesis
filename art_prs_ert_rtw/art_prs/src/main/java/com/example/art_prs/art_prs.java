...
public class art_prs extends AppCompatActivity implements OnFragmentInteractionListener{
    ...
    private String[] scopeTitles = {"Scope2"};
    ...
    private art_prs thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","art_prs"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("art_prs.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
timerZoomButton.start();
    ...
    private native int naMain(String[] argv, art_prs pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("art_prs");
    }
