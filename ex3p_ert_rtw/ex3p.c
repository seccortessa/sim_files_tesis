...
void ex3p_step(void)
{
...

  {
    ...
    if (rtmIsMajorTimeStep(ex3p_M)) {
       ...
       *  Delay: '<Root>/Delay'
       */
      ex3p_B.Sum9 = ex3p_DW.Delay_DSTATE[0] - ex3p_P.offsetConteo_Value;
    }
    ...
    if (rtmIsMajorTimeStep(ex3p_M)) {
      /* S-Function (sdspcount2): '<Root>/Counter' */
      if (MWDSP_EPH_R_D(ex3p_B.Reset, &ex3p_DW.Counter_ClkEphState) != 0U) {
