...
#include "m_tAghQsoIiBKR1jyYBqX3dD.h"
...
static void cgxe_mdl_start(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
...
static void cgxe_mdl_set_sim_state(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_tAghQsoIiBKR1jyYBqX3dD
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S, int_T tid)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S, int_T tid)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
...
static void setSimState_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S)
{
  InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *moduleInstance =
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD *)calloc(1, sizeof
    (InstanceStruct_tAghQsoIiBKR1jyYBqX3dD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_tAghQsoIiBKR1jyYBqX3dD);
  ssSetmdlInitializeConditions(S, mdlInitialize_tAghQsoIiBKR1jyYBqX3dD);
  ssSetmdlUpdate(S, mdlUpdate_tAghQsoIiBKR1jyYBqX3dD);
  ssSetmdlTerminate(S, mdlTerminate_tAghQsoIiBKR1jyYBqX3dD);
  ssSetmdlEnable(S, mdlEnable_tAghQsoIiBKR1jyYBqX3dD);
  ssSetmdlDisable(S, mdlDisable_tAghQsoIiBKR1jyYBqX3dD);
...
static void mdlProcessParameters_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S)
{
}

void method_dispatcher_tAghQsoIiBKR1jyYBqX3dD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_tAghQsoIiBKR1jyYBqX3dD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_tAghQsoIiBKR1jyYBqX3dD(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_tAghQsoIiBKR1jyYBqX3dD(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_tAghQsoIiBKR1jyYBqX3dD(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: tAghQsoIiBKR1jyYBqX3dD.\n"
...
mxArray *cgxe_tAghQsoIiBKR1jyYBqX3dD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_tAghQsoIiBKR1jyYBqX3dD_fallback_info(void)
{
