...
static void cgxe_mdl_start(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S, int_T tid)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S, int_T tid)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S)
{
  InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *moduleInstance =
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC *)calloc(1, sizeof
    (InstanceStruct_EXjWXzdNbMLBy0VqWnKjsC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_EXjWXzdNbMLBy0VqWnKjsC);
  ssSetmdlInitializeConditions(S, mdlInitialize_EXjWXzdNbMLBy0VqWnKjsC);
  ssSetmdlUpdate(S, mdlUpdate_EXjWXzdNbMLBy0VqWnKjsC);
  ssSetmdlTerminate(S, mdlTerminate_EXjWXzdNbMLBy0VqWnKjsC);
  ssSetmdlEnable(S, mdlEnable_EXjWXzdNbMLBy0VqWnKjsC);
  ssSetmdlDisable(S, mdlDisable_EXjWXzdNbMLBy0VqWnKjsC);
...
static void mdlProcessParameters_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S)
{
}

void method_dispatcher_EXjWXzdNbMLBy0VqWnKjsC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_EXjWXzdNbMLBy0VqWnKjsC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_EXjWXzdNbMLBy0VqWnKjsC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_EXjWXzdNbMLBy0VqWnKjsC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_EXjWXzdNbMLBy0VqWnKjsC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: EXjWXzdNbMLBy0VqWnKjsC.\n"
...
mxArray *cgxe_EXjWXzdNbMLBy0VqWnKjsC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_EXjWXzdNbMLBy0VqWnKjsC_fallback_info(void)
{
