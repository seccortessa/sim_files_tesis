...
static void cgxe_mdl_start(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
...
static void cgxe_mdl_set_sim_state(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_jy2tIwPoe1s8ALTGgdhz0
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S, int_T tid)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S, int_T tid)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
...
static void setSimState_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S)
{
  InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *moduleInstance =
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0 *)calloc(1, sizeof
    (InstanceStruct_jy2tIwPoe1s8ALTGgdhz0));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_jy2tIwPoe1s8ALTGgdhz0);
  ssSetmdlInitializeConditions(S, mdlInitialize_jy2tIwPoe1s8ALTGgdhz0);
  ssSetmdlUpdate(S, mdlUpdate_jy2tIwPoe1s8ALTGgdhz0);
  ssSetmdlTerminate(S, mdlTerminate_jy2tIwPoe1s8ALTGgdhz0);
  ssSetmdlEnable(S, mdlEnable_jy2tIwPoe1s8ALTGgdhz0);
  ssSetmdlDisable(S, mdlDisable_jy2tIwPoe1s8ALTGgdhz0);
...
static void mdlProcessParameters_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S)
{
}

void method_dispatcher_jy2tIwPoe1s8ALTGgdhz0(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_jy2tIwPoe1s8ALTGgdhz0(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_jy2tIwPoe1s8ALTGgdhz0(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_jy2tIwPoe1s8ALTGgdhz0(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_jy2tIwPoe1s8ALTGgdhz0(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: jy2tIwPoe1s8ALTGgdhz0.\n"
...
mxArray *cgxe_jy2tIwPoe1s8ALTGgdhz0_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_jy2tIwPoe1s8ALTGgdhz0_fallback_info(void)
{
