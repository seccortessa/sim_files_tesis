...
#include "m_IZ8XkVQOigYJ8K6v6hDj5E.h"
...
static void cgxe_mdl_start(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
...
static void cgxe_mdl_set_sim_state(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S, int_T tid)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S, int_T tid)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
...
static void setSimState_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S)
{
  InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *moduleInstance =
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E *)calloc(1, sizeof
    (InstanceStruct_IZ8XkVQOigYJ8K6v6hDj5E));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_IZ8XkVQOigYJ8K6v6hDj5E);
  ssSetmdlInitializeConditions(S, mdlInitialize_IZ8XkVQOigYJ8K6v6hDj5E);
  ssSetmdlUpdate(S, mdlUpdate_IZ8XkVQOigYJ8K6v6hDj5E);
  ssSetmdlTerminate(S, mdlTerminate_IZ8XkVQOigYJ8K6v6hDj5E);
  ssSetmdlEnable(S, mdlEnable_IZ8XkVQOigYJ8K6v6hDj5E);
  ssSetmdlDisable(S, mdlDisable_IZ8XkVQOigYJ8K6v6hDj5E);
...
static void mdlProcessParameters_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S)
{
}

void method_dispatcher_IZ8XkVQOigYJ8K6v6hDj5E(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_IZ8XkVQOigYJ8K6v6hDj5E(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_IZ8XkVQOigYJ8K6v6hDj5E(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_IZ8XkVQOigYJ8K6v6hDj5E(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_IZ8XkVQOigYJ8K6v6hDj5E(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: IZ8XkVQOigYJ8K6v6hDj5E.\n"
...
mxArray *cgxe_IZ8XkVQOigYJ8K6v6hDj5E_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_IZ8XkVQOigYJ8K6v6hDj5E_fallback_info(void)
{
