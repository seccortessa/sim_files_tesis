#ifndef __FPKYdNYIaiwC3mh1bljkAC_h__
#define __FPKYdNYIaiwC3mh1bljkAC_h__
...
/* Type Definitions */
#ifndef struct_tag_METBfiSVuKP7jr4oo88osE
#define struct_tag_METBfiSVuKP7jr4oo88osE

struct tag_METBfiSVuKP7jr4oo88osE
{
  int32_T isInitialized;
};

#endif                                 /*struct_tag_METBfiSVuKP7jr4oo88osE*/

#ifndef typedef_codertarget_internal_androidLight
#define typedef_codertarget_internal_androidLight

typedef struct tag_METBfiSVuKP7jr4oo88osE codertarget_internal_androidLight;

#endif                                 /*typedef_codertarget_internal_androidLight*/
...
#ifndef typedef_InstanceStruct_FPKYdNYIaiwC3mh1bljkAC
#define typedef_InstanceStruct_FPKYdNYIaiwC3mh1bljkAC

typedef struct {
  SimStruct *S;
  codertarget_internal_androidLight sysobj;
  boolean_T sysobj_not_empty;
  void *emlrtRootTLSGlobal;
  real32_T *b_y0;
} InstanceStruct_FPKYdNYIaiwC3mh1bljkAC;

#endif                                 /*typedef_InstanceStruct_FPKYdNYIaiwC3mh1bljkAC*/
...
extern void method_dispatcher_FPKYdNYIaiwC3mh1bljkAC(SimStruct *S, int_T method,
  void* data);
