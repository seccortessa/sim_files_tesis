...
#include "m_MCelcuA9IuTlQ8xWQgnToB.h"
...
static void cgxe_mdl_start(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
...
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidSlider *obj);
static void mw__internal__call__reset(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance, const emlrtStack *sp);
static real32_T mw__internal__call__step(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance, const emlrtStack *sp, const mxArray *u);
static codertarget_internal_androidSlider b_emlrt_marshallIn(const emlrtStack
  *sp, const mxArray *b_sysobj, const char_T *identifier);
static codertarget_internal_androidSlider c_emlrt_marshallIn(const emlrtStack
...
static void cgxe_mdl_set_sim_state(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_MCelcuA9IuTlQ8xWQgnToB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S, int_T tid)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S, int_T tid)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S)
{
  InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *moduleInstance =
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB *)calloc(1, sizeof
    (InstanceStruct_MCelcuA9IuTlQ8xWQgnToB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_MCelcuA9IuTlQ8xWQgnToB);
  ssSetmdlInitializeConditions(S, mdlInitialize_MCelcuA9IuTlQ8xWQgnToB);
  ssSetmdlUpdate(S, mdlUpdate_MCelcuA9IuTlQ8xWQgnToB);
  ssSetmdlTerminate(S, mdlTerminate_MCelcuA9IuTlQ8xWQgnToB);
  ssSetmdlEnable(S, mdlEnable_MCelcuA9IuTlQ8xWQgnToB);
  ssSetmdlDisable(S, mdlDisable_MCelcuA9IuTlQ8xWQgnToB);
...
static void mdlProcessParameters_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S)
{
}

void method_dispatcher_MCelcuA9IuTlQ8xWQgnToB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_MCelcuA9IuTlQ8xWQgnToB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_MCelcuA9IuTlQ8xWQgnToB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_MCelcuA9IuTlQ8xWQgnToB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_MCelcuA9IuTlQ8xWQgnToB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: MCelcuA9IuTlQ8xWQgnToB.\n"
...
mxArray *cgxe_MCelcuA9IuTlQ8xWQgnToB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_MCelcuA9IuTlQ8xWQgnToB_fallback_info(void)
{
