...
static void cgxe_mdl_start(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_rxrUhDJ8v8GroQHXnm35hB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S, int_T tid)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S, int_T tid)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S)
{
  InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *moduleInstance =
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB *)calloc(1, sizeof
    (InstanceStruct_rxrUhDJ8v8GroQHXnm35hB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_rxrUhDJ8v8GroQHXnm35hB);
  ssSetmdlInitializeConditions(S, mdlInitialize_rxrUhDJ8v8GroQHXnm35hB);
  ssSetmdlUpdate(S, mdlUpdate_rxrUhDJ8v8GroQHXnm35hB);
  ssSetmdlTerminate(S, mdlTerminate_rxrUhDJ8v8GroQHXnm35hB);
  ssSetmdlEnable(S, mdlEnable_rxrUhDJ8v8GroQHXnm35hB);
  ssSetmdlDisable(S, mdlDisable_rxrUhDJ8v8GroQHXnm35hB);
...
static void mdlProcessParameters_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S)
{
}

void method_dispatcher_rxrUhDJ8v8GroQHXnm35hB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_rxrUhDJ8v8GroQHXnm35hB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_rxrUhDJ8v8GroQHXnm35hB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_rxrUhDJ8v8GroQHXnm35hB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_rxrUhDJ8v8GroQHXnm35hB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: rxrUhDJ8v8GroQHXnm35hB.\n"
...
mxArray *cgxe_rxrUhDJ8v8GroQHXnm35hB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_rxrUhDJ8v8GroQHXnm35hB_fallback_info(void)
{
