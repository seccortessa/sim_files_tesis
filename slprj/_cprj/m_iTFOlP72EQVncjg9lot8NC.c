...
static void cgxe_mdl_start(InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_iTFOlP72EQVncjg9lot8NC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_iTFOlP72EQVncjg9lot8NC
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_iTFOlP72EQVncjg9lot8NC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_iTFOlP72EQVncjg9lot8NC(SimStruct *S, int_T tid)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_iTFOlP72EQVncjg9lot8NC(SimStruct *S)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_iTFOlP72EQVncjg9lot8NC(SimStruct *S, int_T tid)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_iTFOlP72EQVncjg9lot8NC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_iTFOlP72EQVncjg9lot8NC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_iTFOlP72EQVncjg9lot8NC(SimStruct *S)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_iTFOlP72EQVncjg9lot8NC(SimStruct *S)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_iTFOlP72EQVncjg9lot8NC(SimStruct *S)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_iTFOlP72EQVncjg9lot8NC(SimStruct *S)
{
  InstanceStruct_iTFOlP72EQVncjg9lot8NC *moduleInstance =
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC *)calloc(1, sizeof
    (InstanceStruct_iTFOlP72EQVncjg9lot8NC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_iTFOlP72EQVncjg9lot8NC);
  ssSetmdlInitializeConditions(S, mdlInitialize_iTFOlP72EQVncjg9lot8NC);
  ssSetmdlUpdate(S, mdlUpdate_iTFOlP72EQVncjg9lot8NC);
  ssSetmdlTerminate(S, mdlTerminate_iTFOlP72EQVncjg9lot8NC);
  ssSetmdlEnable(S, mdlEnable_iTFOlP72EQVncjg9lot8NC);
  ssSetmdlDisable(S, mdlDisable_iTFOlP72EQVncjg9lot8NC);
...
static void mdlProcessParameters_iTFOlP72EQVncjg9lot8NC(SimStruct *S)
{
}

void method_dispatcher_iTFOlP72EQVncjg9lot8NC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_iTFOlP72EQVncjg9lot8NC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_iTFOlP72EQVncjg9lot8NC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_iTFOlP72EQVncjg9lot8NC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_iTFOlP72EQVncjg9lot8NC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: iTFOlP72EQVncjg9lot8NC.\n"
...
mxArray *cgxe_iTFOlP72EQVncjg9lot8NC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_iTFOlP72EQVncjg9lot8NC_fallback_info(void)
{
