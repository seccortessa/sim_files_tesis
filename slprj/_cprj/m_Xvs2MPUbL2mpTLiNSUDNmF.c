...
#include "m_Xvs2MPUbL2mpTLiNSUDNmF.h"
...
static void cgxe_mdl_start(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S, int_T tid)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S, int_T tid)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S)
{
  InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *moduleInstance =
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF *)calloc(1, sizeof
    (InstanceStruct_Xvs2MPUbL2mpTLiNSUDNmF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Xvs2MPUbL2mpTLiNSUDNmF);
  ssSetmdlInitializeConditions(S, mdlInitialize_Xvs2MPUbL2mpTLiNSUDNmF);
  ssSetmdlUpdate(S, mdlUpdate_Xvs2MPUbL2mpTLiNSUDNmF);
  ssSetmdlTerminate(S, mdlTerminate_Xvs2MPUbL2mpTLiNSUDNmF);
  ssSetmdlEnable(S, mdlEnable_Xvs2MPUbL2mpTLiNSUDNmF);
  ssSetmdlDisable(S, mdlDisable_Xvs2MPUbL2mpTLiNSUDNmF);
...
static void mdlProcessParameters_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S)
{
}

void method_dispatcher_Xvs2MPUbL2mpTLiNSUDNmF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Xvs2MPUbL2mpTLiNSUDNmF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Xvs2MPUbL2mpTLiNSUDNmF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_Xvs2MPUbL2mpTLiNSUDNmF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_Xvs2MPUbL2mpTLiNSUDNmF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Xvs2MPUbL2mpTLiNSUDNmF.\n"
...
mxArray *cgxe_Xvs2MPUbL2mpTLiNSUDNmF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Xvs2MPUbL2mpTLiNSUDNmF_fallback_info(void)
{
