...
#include "m_siRigsp7fnJRfNW4hfeWYH.h"
...
static void cgxe_mdl_start(InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_siRigsp7fnJRfNW4hfeWYH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_siRigsp7fnJRfNW4hfeWYH(SimStruct *S, int_T tid)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_siRigsp7fnJRfNW4hfeWYH(SimStruct *S)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_siRigsp7fnJRfNW4hfeWYH(SimStruct *S, int_T tid)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_siRigsp7fnJRfNW4hfeWYH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_siRigsp7fnJRfNW4hfeWYH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_siRigsp7fnJRfNW4hfeWYH(SimStruct *S)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_siRigsp7fnJRfNW4hfeWYH(SimStruct *S)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_siRigsp7fnJRfNW4hfeWYH(SimStruct *S)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_siRigsp7fnJRfNW4hfeWYH(SimStruct *S)
{
  InstanceStruct_siRigsp7fnJRfNW4hfeWYH *moduleInstance =
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH *)calloc(1, sizeof
    (InstanceStruct_siRigsp7fnJRfNW4hfeWYH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_siRigsp7fnJRfNW4hfeWYH);
  ssSetmdlInitializeConditions(S, mdlInitialize_siRigsp7fnJRfNW4hfeWYH);
  ssSetmdlUpdate(S, mdlUpdate_siRigsp7fnJRfNW4hfeWYH);
  ssSetmdlTerminate(S, mdlTerminate_siRigsp7fnJRfNW4hfeWYH);
  ssSetmdlEnable(S, mdlEnable_siRigsp7fnJRfNW4hfeWYH);
  ssSetmdlDisable(S, mdlDisable_siRigsp7fnJRfNW4hfeWYH);
...
static void mdlProcessParameters_siRigsp7fnJRfNW4hfeWYH(SimStruct *S)
{
}

void method_dispatcher_siRigsp7fnJRfNW4hfeWYH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_siRigsp7fnJRfNW4hfeWYH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_siRigsp7fnJRfNW4hfeWYH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_siRigsp7fnJRfNW4hfeWYH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_siRigsp7fnJRfNW4hfeWYH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: siRigsp7fnJRfNW4hfeWYH.\n"
...
mxArray *cgxe_siRigsp7fnJRfNW4hfeWYH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_siRigsp7fnJRfNW4hfeWYH_fallback_info(void)
{
