...
#include "m_q2CMdBQwo7C2ONb2aREl4.h"
...
static void cgxe_mdl_start(InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
...
static void cgxe_mdl_set_sim_state(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_q2CMdBQwo7C2ONb2aREl4
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_q2CMdBQwo7C2ONb2aREl4(SimStruct *S, int_T tid)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_q2CMdBQwo7C2ONb2aREl4(SimStruct *S)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_q2CMdBQwo7C2ONb2aREl4(SimStruct *S, int_T tid)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_q2CMdBQwo7C2ONb2aREl4(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
...
static void setSimState_q2CMdBQwo7C2ONb2aREl4(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_q2CMdBQwo7C2ONb2aREl4(SimStruct *S)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_q2CMdBQwo7C2ONb2aREl4(SimStruct *S)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_q2CMdBQwo7C2ONb2aREl4(SimStruct *S)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_q2CMdBQwo7C2ONb2aREl4(SimStruct *S)
{
  InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *moduleInstance =
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4 *)calloc(1, sizeof
    (InstanceStruct_q2CMdBQwo7C2ONb2aREl4));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_q2CMdBQwo7C2ONb2aREl4);
  ssSetmdlInitializeConditions(S, mdlInitialize_q2CMdBQwo7C2ONb2aREl4);
  ssSetmdlUpdate(S, mdlUpdate_q2CMdBQwo7C2ONb2aREl4);
  ssSetmdlTerminate(S, mdlTerminate_q2CMdBQwo7C2ONb2aREl4);
  ssSetmdlEnable(S, mdlEnable_q2CMdBQwo7C2ONb2aREl4);
  ssSetmdlDisable(S, mdlDisable_q2CMdBQwo7C2ONb2aREl4);
...
static void mdlProcessParameters_q2CMdBQwo7C2ONb2aREl4(SimStruct *S)
{
}

void method_dispatcher_q2CMdBQwo7C2ONb2aREl4(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_q2CMdBQwo7C2ONb2aREl4(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_q2CMdBQwo7C2ONb2aREl4(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_q2CMdBQwo7C2ONb2aREl4(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_q2CMdBQwo7C2ONb2aREl4(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: q2CMdBQwo7C2ONb2aREl4.\n"
...
mxArray *cgxe_q2CMdBQwo7C2ONb2aREl4_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_q2CMdBQwo7C2ONb2aREl4_fallback_info(void)
{
