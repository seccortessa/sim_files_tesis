#ifndef __B18doyDGgu6UCK4RTFow0F_h__
#define __B18doyDGgu6UCK4RTFow0F_h__
...
/* Type Definitions */
#ifndef struct_tag_wluhZvwlIfyzEJodj7jMxD
#define struct_tag_wluhZvwlIfyzEJodj7jMxD

struct tag_wluhZvwlIfyzEJodj7jMxD
{
  int32_T isInitialized;
};

#endif                                 /*struct_tag_wluhZvwlIfyzEJodj7jMxD*/

#ifndef typedef_codertarget_internal_androidMagnetometer
#define typedef_codertarget_internal_androidMagnetometer

typedef struct tag_wluhZvwlIfyzEJodj7jMxD
  codertarget_internal_androidMagnetometer;

#endif                                 /*typedef_codertarget_internal_androidMagnetometer*/
...
#ifndef typedef_InstanceStruct_B18doyDGgu6UCK4RTFow0F
#define typedef_InstanceStruct_B18doyDGgu6UCK4RTFow0F

typedef struct {
  SimStruct *S;
  codertarget_internal_androidMagnetometer sysobj;
  boolean_T sysobj_not_empty;
  void *emlrtRootTLSGlobal;
  real32_T (*b_y0)[3];
} InstanceStruct_B18doyDGgu6UCK4RTFow0F;

#endif                                 /*typedef_InstanceStruct_B18doyDGgu6UCK4RTFow0F*/
...
extern void method_dispatcher_B18doyDGgu6UCK4RTFow0F(SimStruct *S, int_T method,
  void* data);
