...
static void cgxe_mdl_start(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
...
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidSlider *obj);
static void mw__internal__call__reset(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance, const emlrtStack *sp);
static real32_T mw__internal__call__step(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_VAo42vv3L4iwLQVN4nVbMH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S, int_T tid)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S, int_T tid)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S)
{
  InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *moduleInstance =
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH *)calloc(1, sizeof
    (InstanceStruct_VAo42vv3L4iwLQVN4nVbMH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_VAo42vv3L4iwLQVN4nVbMH);
  ssSetmdlInitializeConditions(S, mdlInitialize_VAo42vv3L4iwLQVN4nVbMH);
  ssSetmdlUpdate(S, mdlUpdate_VAo42vv3L4iwLQVN4nVbMH);
  ssSetmdlTerminate(S, mdlTerminate_VAo42vv3L4iwLQVN4nVbMH);
  ssSetmdlEnable(S, mdlEnable_VAo42vv3L4iwLQVN4nVbMH);
  ssSetmdlDisable(S, mdlDisable_VAo42vv3L4iwLQVN4nVbMH);
...
static void mdlProcessParameters_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S)
{
}

void method_dispatcher_VAo42vv3L4iwLQVN4nVbMH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_VAo42vv3L4iwLQVN4nVbMH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_VAo42vv3L4iwLQVN4nVbMH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_VAo42vv3L4iwLQVN4nVbMH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_VAo42vv3L4iwLQVN4nVbMH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: VAo42vv3L4iwLQVN4nVbMH.\n"
...
mxArray *cgxe_VAo42vv3L4iwLQVN4nVbMH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_VAo42vv3L4iwLQVN4nVbMH_fallback_info(void)
{
