...
static void cgxe_mdl_start(InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_xjehGAySTGJ90JsFRWESpG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_xjehGAySTGJ90JsFRWESpG
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_xjehGAySTGJ90JsFRWESpG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_xjehGAySTGJ90JsFRWESpG(SimStruct *S, int_T tid)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_xjehGAySTGJ90JsFRWESpG(SimStruct *S)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_xjehGAySTGJ90JsFRWESpG(SimStruct *S, int_T tid)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_xjehGAySTGJ90JsFRWESpG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_xjehGAySTGJ90JsFRWESpG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_xjehGAySTGJ90JsFRWESpG(SimStruct *S)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_xjehGAySTGJ90JsFRWESpG(SimStruct *S)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_xjehGAySTGJ90JsFRWESpG(SimStruct *S)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_xjehGAySTGJ90JsFRWESpG(SimStruct *S)
{
  InstanceStruct_xjehGAySTGJ90JsFRWESpG *moduleInstance =
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG *)calloc(1, sizeof
    (InstanceStruct_xjehGAySTGJ90JsFRWESpG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_xjehGAySTGJ90JsFRWESpG);
  ssSetmdlInitializeConditions(S, mdlInitialize_xjehGAySTGJ90JsFRWESpG);
  ssSetmdlUpdate(S, mdlUpdate_xjehGAySTGJ90JsFRWESpG);
  ssSetmdlTerminate(S, mdlTerminate_xjehGAySTGJ90JsFRWESpG);
  ssSetmdlEnable(S, mdlEnable_xjehGAySTGJ90JsFRWESpG);
  ssSetmdlDisable(S, mdlDisable_xjehGAySTGJ90JsFRWESpG);
...
static void mdlProcessParameters_xjehGAySTGJ90JsFRWESpG(SimStruct *S)
{
}

void method_dispatcher_xjehGAySTGJ90JsFRWESpG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_xjehGAySTGJ90JsFRWESpG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_xjehGAySTGJ90JsFRWESpG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_xjehGAySTGJ90JsFRWESpG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_xjehGAySTGJ90JsFRWESpG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: xjehGAySTGJ90JsFRWESpG.\n"
...
mxArray *cgxe_xjehGAySTGJ90JsFRWESpG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_xjehGAySTGJ90JsFRWESpG_fallback_info(void)
{
