...
static void cgxe_mdl_start(InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_LexgXzvW4awE3AingrVslE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_LexgXzvW4awE3AingrVslE
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_LexgXzvW4awE3AingrVslE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_LexgXzvW4awE3AingrVslE(SimStruct *S, int_T tid)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_LexgXzvW4awE3AingrVslE(SimStruct *S)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_LexgXzvW4awE3AingrVslE(SimStruct *S, int_T tid)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_LexgXzvW4awE3AingrVslE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_LexgXzvW4awE3AingrVslE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_LexgXzvW4awE3AingrVslE(SimStruct *S)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_LexgXzvW4awE3AingrVslE(SimStruct *S)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_LexgXzvW4awE3AingrVslE(SimStruct *S)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_LexgXzvW4awE3AingrVslE(SimStruct *S)
{
  InstanceStruct_LexgXzvW4awE3AingrVslE *moduleInstance =
    (InstanceStruct_LexgXzvW4awE3AingrVslE *)calloc(1, sizeof
    (InstanceStruct_LexgXzvW4awE3AingrVslE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_LexgXzvW4awE3AingrVslE);
  ssSetmdlInitializeConditions(S, mdlInitialize_LexgXzvW4awE3AingrVslE);
  ssSetmdlUpdate(S, mdlUpdate_LexgXzvW4awE3AingrVslE);
  ssSetmdlTerminate(S, mdlTerminate_LexgXzvW4awE3AingrVslE);
  ssSetmdlEnable(S, mdlEnable_LexgXzvW4awE3AingrVslE);
  ssSetmdlDisable(S, mdlDisable_LexgXzvW4awE3AingrVslE);
...
static void mdlProcessParameters_LexgXzvW4awE3AingrVslE(SimStruct *S)
{
}

void method_dispatcher_LexgXzvW4awE3AingrVslE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_LexgXzvW4awE3AingrVslE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_LexgXzvW4awE3AingrVslE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_LexgXzvW4awE3AingrVslE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_LexgXzvW4awE3AingrVslE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: LexgXzvW4awE3AingrVslE.\n"
...
mxArray *cgxe_LexgXzvW4awE3AingrVslE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_LexgXzvW4awE3AingrVslE_fallback_info(void)
{
