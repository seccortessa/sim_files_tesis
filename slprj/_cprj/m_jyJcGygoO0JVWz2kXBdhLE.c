...
#include "m_jyJcGygoO0JVWz2kXBdhLE.h"
...
static void cgxe_mdl_start(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_jyJcGygoO0JVWz2kXBdhLE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S, int_T tid)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S, int_T tid)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S)
{
  InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *moduleInstance =
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE *)calloc(1, sizeof
    (InstanceStruct_jyJcGygoO0JVWz2kXBdhLE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_jyJcGygoO0JVWz2kXBdhLE);
  ssSetmdlInitializeConditions(S, mdlInitialize_jyJcGygoO0JVWz2kXBdhLE);
  ssSetmdlUpdate(S, mdlUpdate_jyJcGygoO0JVWz2kXBdhLE);
  ssSetmdlTerminate(S, mdlTerminate_jyJcGygoO0JVWz2kXBdhLE);
  ssSetmdlEnable(S, mdlEnable_jyJcGygoO0JVWz2kXBdhLE);
  ssSetmdlDisable(S, mdlDisable_jyJcGygoO0JVWz2kXBdhLE);
...
static void mdlProcessParameters_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S)
{
}

void method_dispatcher_jyJcGygoO0JVWz2kXBdhLE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_jyJcGygoO0JVWz2kXBdhLE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_jyJcGygoO0JVWz2kXBdhLE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_jyJcGygoO0JVWz2kXBdhLE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_jyJcGygoO0JVWz2kXBdhLE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: jyJcGygoO0JVWz2kXBdhLE.\n"
...
mxArray *cgxe_jyJcGygoO0JVWz2kXBdhLE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_jyJcGygoO0JVWz2kXBdhLE_fallback_info(void)
{
