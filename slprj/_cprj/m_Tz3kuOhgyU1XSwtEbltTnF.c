...
static void cgxe_mdl_start(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S, int_T tid)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S, int_T tid)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S)
{
  InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *moduleInstance =
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF *)calloc(1, sizeof
    (InstanceStruct_Tz3kuOhgyU1XSwtEbltTnF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Tz3kuOhgyU1XSwtEbltTnF);
  ssSetmdlInitializeConditions(S, mdlInitialize_Tz3kuOhgyU1XSwtEbltTnF);
  ssSetmdlUpdate(S, mdlUpdate_Tz3kuOhgyU1XSwtEbltTnF);
  ssSetmdlTerminate(S, mdlTerminate_Tz3kuOhgyU1XSwtEbltTnF);
  ssSetmdlEnable(S, mdlEnable_Tz3kuOhgyU1XSwtEbltTnF);
  ssSetmdlDisable(S, mdlDisable_Tz3kuOhgyU1XSwtEbltTnF);
...
static void mdlProcessParameters_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S)
{
}

void method_dispatcher_Tz3kuOhgyU1XSwtEbltTnF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Tz3kuOhgyU1XSwtEbltTnF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Tz3kuOhgyU1XSwtEbltTnF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_Tz3kuOhgyU1XSwtEbltTnF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_Tz3kuOhgyU1XSwtEbltTnF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Tz3kuOhgyU1XSwtEbltTnF.\n"
...
mxArray *cgxe_Tz3kuOhgyU1XSwtEbltTnF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Tz3kuOhgyU1XSwtEbltTnF_fallback_info(void)
{
