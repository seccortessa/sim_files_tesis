...
#include "m_7d7eSkxBwiXHOOXhwabJcC.h"
...
static void cgxe_mdl_start(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_7d7eSkxBwiXHOOXhwabJcC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S, int_T tid)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S, int_T tid)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S)
{
  InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *moduleInstance =
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC *)calloc(1, sizeof
    (InstanceStruct_7d7eSkxBwiXHOOXhwabJcC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_7d7eSkxBwiXHOOXhwabJcC);
  ssSetmdlInitializeConditions(S, mdlInitialize_7d7eSkxBwiXHOOXhwabJcC);
  ssSetmdlUpdate(S, mdlUpdate_7d7eSkxBwiXHOOXhwabJcC);
  ssSetmdlTerminate(S, mdlTerminate_7d7eSkxBwiXHOOXhwabJcC);
  ssSetmdlEnable(S, mdlEnable_7d7eSkxBwiXHOOXhwabJcC);
  ssSetmdlDisable(S, mdlDisable_7d7eSkxBwiXHOOXhwabJcC);
...
static void mdlProcessParameters_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S)
{
}

void method_dispatcher_7d7eSkxBwiXHOOXhwabJcC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_7d7eSkxBwiXHOOXhwabJcC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_7d7eSkxBwiXHOOXhwabJcC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_7d7eSkxBwiXHOOXhwabJcC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_7d7eSkxBwiXHOOXhwabJcC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 7d7eSkxBwiXHOOXhwabJcC.\n"
...
mxArray *cgxe_7d7eSkxBwiXHOOXhwabJcC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_7d7eSkxBwiXHOOXhwabJcC_fallback_info(void)
{
