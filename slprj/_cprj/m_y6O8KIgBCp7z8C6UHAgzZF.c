...
static void cgxe_mdl_start(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S, int_T tid)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S, int_T tid)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S)
{
  InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *moduleInstance =
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF *)calloc(1, sizeof
    (InstanceStruct_y6O8KIgBCp7z8C6UHAgzZF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_y6O8KIgBCp7z8C6UHAgzZF);
  ssSetmdlInitializeConditions(S, mdlInitialize_y6O8KIgBCp7z8C6UHAgzZF);
  ssSetmdlUpdate(S, mdlUpdate_y6O8KIgBCp7z8C6UHAgzZF);
  ssSetmdlTerminate(S, mdlTerminate_y6O8KIgBCp7z8C6UHAgzZF);
  ssSetmdlEnable(S, mdlEnable_y6O8KIgBCp7z8C6UHAgzZF);
  ssSetmdlDisable(S, mdlDisable_y6O8KIgBCp7z8C6UHAgzZF);
...
static void mdlProcessParameters_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S)
{
}

void method_dispatcher_y6O8KIgBCp7z8C6UHAgzZF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_y6O8KIgBCp7z8C6UHAgzZF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_y6O8KIgBCp7z8C6UHAgzZF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_y6O8KIgBCp7z8C6UHAgzZF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_y6O8KIgBCp7z8C6UHAgzZF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: y6O8KIgBCp7z8C6UHAgzZF.\n"
...
mxArray *cgxe_y6O8KIgBCp7z8C6UHAgzZF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_y6O8KIgBCp7z8C6UHAgzZF_fallback_info(void)
{
