...
#include "m_WEOG3ONeggu32rvGX93flG.h"
...
static void cgxe_mdl_start(InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_WEOG3ONeggu32rvGX93flG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_WEOG3ONeggu32rvGX93flG
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_WEOG3ONeggu32rvGX93flG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_WEOG3ONeggu32rvGX93flG(SimStruct *S, int_T tid)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_WEOG3ONeggu32rvGX93flG(SimStruct *S)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_WEOG3ONeggu32rvGX93flG(SimStruct *S, int_T tid)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_WEOG3ONeggu32rvGX93flG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_WEOG3ONeggu32rvGX93flG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_WEOG3ONeggu32rvGX93flG(SimStruct *S)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_WEOG3ONeggu32rvGX93flG(SimStruct *S)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_WEOG3ONeggu32rvGX93flG(SimStruct *S)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_WEOG3ONeggu32rvGX93flG(SimStruct *S)
{
  InstanceStruct_WEOG3ONeggu32rvGX93flG *moduleInstance =
    (InstanceStruct_WEOG3ONeggu32rvGX93flG *)calloc(1, sizeof
    (InstanceStruct_WEOG3ONeggu32rvGX93flG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_WEOG3ONeggu32rvGX93flG);
  ssSetmdlInitializeConditions(S, mdlInitialize_WEOG3ONeggu32rvGX93flG);
  ssSetmdlUpdate(S, mdlUpdate_WEOG3ONeggu32rvGX93flG);
  ssSetmdlTerminate(S, mdlTerminate_WEOG3ONeggu32rvGX93flG);
  ssSetmdlEnable(S, mdlEnable_WEOG3ONeggu32rvGX93flG);
  ssSetmdlDisable(S, mdlDisable_WEOG3ONeggu32rvGX93flG);
...
static void mdlProcessParameters_WEOG3ONeggu32rvGX93flG(SimStruct *S)
{
}

void method_dispatcher_WEOG3ONeggu32rvGX93flG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_WEOG3ONeggu32rvGX93flG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_WEOG3ONeggu32rvGX93flG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_WEOG3ONeggu32rvGX93flG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_WEOG3ONeggu32rvGX93flG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: WEOG3ONeggu32rvGX93flG.\n"
...
mxArray *cgxe_WEOG3ONeggu32rvGX93flG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_WEOG3ONeggu32rvGX93flG_fallback_info(void)
{
