...
static void cgxe_mdl_start(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
...
static void cgxe_mdl_set_sim_state(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S, int_T tid)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S, int_T tid)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
...
static void setSimState_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S)
{
  InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *moduleInstance =
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G *)calloc(1, sizeof
    (InstanceStruct_Ot94l1wQvH6zQZ8qvHVS5G));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Ot94l1wQvH6zQZ8qvHVS5G);
  ssSetmdlInitializeConditions(S, mdlInitialize_Ot94l1wQvH6zQZ8qvHVS5G);
  ssSetmdlUpdate(S, mdlUpdate_Ot94l1wQvH6zQZ8qvHVS5G);
  ssSetmdlTerminate(S, mdlTerminate_Ot94l1wQvH6zQZ8qvHVS5G);
  ssSetmdlEnable(S, mdlEnable_Ot94l1wQvH6zQZ8qvHVS5G);
  ssSetmdlDisable(S, mdlDisable_Ot94l1wQvH6zQZ8qvHVS5G);
...
static void mdlProcessParameters_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S)
{
}

void method_dispatcher_Ot94l1wQvH6zQZ8qvHVS5G(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Ot94l1wQvH6zQZ8qvHVS5G(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Ot94l1wQvH6zQZ8qvHVS5G(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_Ot94l1wQvH6zQZ8qvHVS5G(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_Ot94l1wQvH6zQZ8qvHVS5G(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Ot94l1wQvH6zQZ8qvHVS5G.\n"
...
mxArray *cgxe_Ot94l1wQvH6zQZ8qvHVS5G_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Ot94l1wQvH6zQZ8qvHVS5G_fallback_info(void)
{
