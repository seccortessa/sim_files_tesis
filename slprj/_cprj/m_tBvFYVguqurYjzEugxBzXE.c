...
static void cgxe_mdl_start(InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_tBvFYVguqurYjzEugxBzXE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_tBvFYVguqurYjzEugxBzXE
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_tBvFYVguqurYjzEugxBzXE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_tBvFYVguqurYjzEugxBzXE(SimStruct *S, int_T tid)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_tBvFYVguqurYjzEugxBzXE(SimStruct *S)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_tBvFYVguqurYjzEugxBzXE(SimStruct *S, int_T tid)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_tBvFYVguqurYjzEugxBzXE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_tBvFYVguqurYjzEugxBzXE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_tBvFYVguqurYjzEugxBzXE(SimStruct *S)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_tBvFYVguqurYjzEugxBzXE(SimStruct *S)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_tBvFYVguqurYjzEugxBzXE(SimStruct *S)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_tBvFYVguqurYjzEugxBzXE(SimStruct *S)
{
  InstanceStruct_tBvFYVguqurYjzEugxBzXE *moduleInstance =
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE *)calloc(1, sizeof
    (InstanceStruct_tBvFYVguqurYjzEugxBzXE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_tBvFYVguqurYjzEugxBzXE);
  ssSetmdlInitializeConditions(S, mdlInitialize_tBvFYVguqurYjzEugxBzXE);
  ssSetmdlUpdate(S, mdlUpdate_tBvFYVguqurYjzEugxBzXE);
  ssSetmdlTerminate(S, mdlTerminate_tBvFYVguqurYjzEugxBzXE);
  ssSetmdlEnable(S, mdlEnable_tBvFYVguqurYjzEugxBzXE);
  ssSetmdlDisable(S, mdlDisable_tBvFYVguqurYjzEugxBzXE);
...
static void mdlProcessParameters_tBvFYVguqurYjzEugxBzXE(SimStruct *S)
{
}

void method_dispatcher_tBvFYVguqurYjzEugxBzXE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_tBvFYVguqurYjzEugxBzXE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_tBvFYVguqurYjzEugxBzXE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_tBvFYVguqurYjzEugxBzXE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_tBvFYVguqurYjzEugxBzXE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: tBvFYVguqurYjzEugxBzXE.\n"
...
mxArray *cgxe_tBvFYVguqurYjzEugxBzXE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_tBvFYVguqurYjzEugxBzXE_fallback_info(void)
{
