...
#include "m_jpN4V8nRBZ19Qo0HM1C1cB.h"
...
static void cgxe_mdl_start(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S, int_T tid)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S, int_T tid)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S)
{
  InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *moduleInstance =
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB *)calloc(1, sizeof
    (InstanceStruct_jpN4V8nRBZ19Qo0HM1C1cB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_jpN4V8nRBZ19Qo0HM1C1cB);
  ssSetmdlInitializeConditions(S, mdlInitialize_jpN4V8nRBZ19Qo0HM1C1cB);
  ssSetmdlUpdate(S, mdlUpdate_jpN4V8nRBZ19Qo0HM1C1cB);
  ssSetmdlTerminate(S, mdlTerminate_jpN4V8nRBZ19Qo0HM1C1cB);
  ssSetmdlEnable(S, mdlEnable_jpN4V8nRBZ19Qo0HM1C1cB);
  ssSetmdlDisable(S, mdlDisable_jpN4V8nRBZ19Qo0HM1C1cB);
...
static void mdlProcessParameters_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S)
{
}

void method_dispatcher_jpN4V8nRBZ19Qo0HM1C1cB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_jpN4V8nRBZ19Qo0HM1C1cB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_jpN4V8nRBZ19Qo0HM1C1cB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_jpN4V8nRBZ19Qo0HM1C1cB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_jpN4V8nRBZ19Qo0HM1C1cB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: jpN4V8nRBZ19Qo0HM1C1cB.\n"
...
mxArray *cgxe_jpN4V8nRBZ19Qo0HM1C1cB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_jpN4V8nRBZ19Qo0HM1C1cB_fallback_info(void)
{
