...
#include "m_l6WNEwegbe6ekuo8EkOKJB.h"
...
static void cgxe_mdl_start(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_l6WNEwegbe6ekuo8EkOKJB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S, int_T tid)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S, int_T tid)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S)
{
  InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *moduleInstance =
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB *)calloc(1, sizeof
    (InstanceStruct_l6WNEwegbe6ekuo8EkOKJB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_l6WNEwegbe6ekuo8EkOKJB);
  ssSetmdlInitializeConditions(S, mdlInitialize_l6WNEwegbe6ekuo8EkOKJB);
  ssSetmdlUpdate(S, mdlUpdate_l6WNEwegbe6ekuo8EkOKJB);
  ssSetmdlTerminate(S, mdlTerminate_l6WNEwegbe6ekuo8EkOKJB);
  ssSetmdlEnable(S, mdlEnable_l6WNEwegbe6ekuo8EkOKJB);
  ssSetmdlDisable(S, mdlDisable_l6WNEwegbe6ekuo8EkOKJB);
...
static void mdlProcessParameters_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S)
{
}

void method_dispatcher_l6WNEwegbe6ekuo8EkOKJB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_l6WNEwegbe6ekuo8EkOKJB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_l6WNEwegbe6ekuo8EkOKJB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_l6WNEwegbe6ekuo8EkOKJB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_l6WNEwegbe6ekuo8EkOKJB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: l6WNEwegbe6ekuo8EkOKJB.\n"
...
mxArray *cgxe_l6WNEwegbe6ekuo8EkOKJB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_l6WNEwegbe6ekuo8EkOKJB_fallback_info(void)
{
