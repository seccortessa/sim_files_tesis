...
static void cgxe_mdl_start(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S, int_T tid)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S, int_T tid)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S)
{
  InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *moduleInstance =
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC *)calloc(1, sizeof
    (InstanceStruct_RoCtFZqzoy2MuRSqhBv9HC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_RoCtFZqzoy2MuRSqhBv9HC);
  ssSetmdlInitializeConditions(S, mdlInitialize_RoCtFZqzoy2MuRSqhBv9HC);
  ssSetmdlUpdate(S, mdlUpdate_RoCtFZqzoy2MuRSqhBv9HC);
  ssSetmdlTerminate(S, mdlTerminate_RoCtFZqzoy2MuRSqhBv9HC);
  ssSetmdlEnable(S, mdlEnable_RoCtFZqzoy2MuRSqhBv9HC);
  ssSetmdlDisable(S, mdlDisable_RoCtFZqzoy2MuRSqhBv9HC);
...
static void mdlProcessParameters_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S)
{
}

void method_dispatcher_RoCtFZqzoy2MuRSqhBv9HC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_RoCtFZqzoy2MuRSqhBv9HC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_RoCtFZqzoy2MuRSqhBv9HC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_RoCtFZqzoy2MuRSqhBv9HC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_RoCtFZqzoy2MuRSqhBv9HC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: RoCtFZqzoy2MuRSqhBv9HC.\n"
...
mxArray *cgxe_RoCtFZqzoy2MuRSqhBv9HC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_RoCtFZqzoy2MuRSqhBv9HC_fallback_info(void)
{
