...
#include "m_LmvVHdFbVZCYgULAbIdBRF.h"
...
static void cgxe_mdl_start(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_LmvVHdFbVZCYgULAbIdBRF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S, int_T tid)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S, int_T tid)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S)
{
  InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *moduleInstance =
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF *)calloc(1, sizeof
    (InstanceStruct_LmvVHdFbVZCYgULAbIdBRF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_LmvVHdFbVZCYgULAbIdBRF);
  ssSetmdlInitializeConditions(S, mdlInitialize_LmvVHdFbVZCYgULAbIdBRF);
  ssSetmdlUpdate(S, mdlUpdate_LmvVHdFbVZCYgULAbIdBRF);
  ssSetmdlTerminate(S, mdlTerminate_LmvVHdFbVZCYgULAbIdBRF);
  ssSetmdlEnable(S, mdlEnable_LmvVHdFbVZCYgULAbIdBRF);
  ssSetmdlDisable(S, mdlDisable_LmvVHdFbVZCYgULAbIdBRF);
...
static void mdlProcessParameters_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S)
{
}

void method_dispatcher_LmvVHdFbVZCYgULAbIdBRF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_LmvVHdFbVZCYgULAbIdBRF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_LmvVHdFbVZCYgULAbIdBRF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_LmvVHdFbVZCYgULAbIdBRF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_LmvVHdFbVZCYgULAbIdBRF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: LmvVHdFbVZCYgULAbIdBRF.\n"
...
mxArray *cgxe_LmvVHdFbVZCYgULAbIdBRF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_LmvVHdFbVZCYgULAbIdBRF_fallback_info(void)
{
