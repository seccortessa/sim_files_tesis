...
static void cgxe_mdl_start(InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
...
static void cgxe_mdl_set_sim_state(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_9ispRWRowcT7MDgt3HGJHD
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_9ispRWRowcT7MDgt3HGJHD(SimStruct *S, int_T tid)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_9ispRWRowcT7MDgt3HGJHD(SimStruct *S)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_9ispRWRowcT7MDgt3HGJHD(SimStruct *S, int_T tid)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_9ispRWRowcT7MDgt3HGJHD(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
...
static void setSimState_9ispRWRowcT7MDgt3HGJHD(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_9ispRWRowcT7MDgt3HGJHD(SimStruct *S)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_9ispRWRowcT7MDgt3HGJHD(SimStruct *S)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_9ispRWRowcT7MDgt3HGJHD(SimStruct *S)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_9ispRWRowcT7MDgt3HGJHD(SimStruct *S)
{
  InstanceStruct_9ispRWRowcT7MDgt3HGJHD *moduleInstance =
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD *)calloc(1, sizeof
    (InstanceStruct_9ispRWRowcT7MDgt3HGJHD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_9ispRWRowcT7MDgt3HGJHD);
  ssSetmdlInitializeConditions(S, mdlInitialize_9ispRWRowcT7MDgt3HGJHD);
  ssSetmdlUpdate(S, mdlUpdate_9ispRWRowcT7MDgt3HGJHD);
  ssSetmdlTerminate(S, mdlTerminate_9ispRWRowcT7MDgt3HGJHD);
  ssSetmdlEnable(S, mdlEnable_9ispRWRowcT7MDgt3HGJHD);
  ssSetmdlDisable(S, mdlDisable_9ispRWRowcT7MDgt3HGJHD);
...
static void mdlProcessParameters_9ispRWRowcT7MDgt3HGJHD(SimStruct *S)
{
}

void method_dispatcher_9ispRWRowcT7MDgt3HGJHD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_9ispRWRowcT7MDgt3HGJHD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_9ispRWRowcT7MDgt3HGJHD(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_9ispRWRowcT7MDgt3HGJHD(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_9ispRWRowcT7MDgt3HGJHD(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 9ispRWRowcT7MDgt3HGJHD.\n"
...
mxArray *cgxe_9ispRWRowcT7MDgt3HGJHD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_9ispRWRowcT7MDgt3HGJHD_fallback_info(void)
{
