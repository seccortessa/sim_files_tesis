...
static void cgxe_mdl_start(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S, int_T tid)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S, int_T tid)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S)
{
  InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *moduleInstance =
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG *)calloc(1, sizeof
    (InstanceStruct_w3Iq9f6TtaPkClG6RmfRJG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_w3Iq9f6TtaPkClG6RmfRJG);
  ssSetmdlInitializeConditions(S, mdlInitialize_w3Iq9f6TtaPkClG6RmfRJG);
  ssSetmdlUpdate(S, mdlUpdate_w3Iq9f6TtaPkClG6RmfRJG);
  ssSetmdlTerminate(S, mdlTerminate_w3Iq9f6TtaPkClG6RmfRJG);
  ssSetmdlEnable(S, mdlEnable_w3Iq9f6TtaPkClG6RmfRJG);
  ssSetmdlDisable(S, mdlDisable_w3Iq9f6TtaPkClG6RmfRJG);
...
static void mdlProcessParameters_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S)
{
}

void method_dispatcher_w3Iq9f6TtaPkClG6RmfRJG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_w3Iq9f6TtaPkClG6RmfRJG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_w3Iq9f6TtaPkClG6RmfRJG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_w3Iq9f6TtaPkClG6RmfRJG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_w3Iq9f6TtaPkClG6RmfRJG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: w3Iq9f6TtaPkClG6RmfRJG.\n"
...
mxArray *cgxe_w3Iq9f6TtaPkClG6RmfRJG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_w3Iq9f6TtaPkClG6RmfRJG_fallback_info(void)
{
