...
static void cgxe_mdl_start(InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_HRQ8wXDZJRP84ult25fVAH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_HRQ8wXDZJRP84ult25fVAH(SimStruct *S, int_T tid)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_HRQ8wXDZJRP84ult25fVAH(SimStruct *S)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_HRQ8wXDZJRP84ult25fVAH(SimStruct *S, int_T tid)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_HRQ8wXDZJRP84ult25fVAH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_HRQ8wXDZJRP84ult25fVAH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_HRQ8wXDZJRP84ult25fVAH(SimStruct *S)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_HRQ8wXDZJRP84ult25fVAH(SimStruct *S)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_HRQ8wXDZJRP84ult25fVAH(SimStruct *S)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_HRQ8wXDZJRP84ult25fVAH(SimStruct *S)
{
  InstanceStruct_HRQ8wXDZJRP84ult25fVAH *moduleInstance =
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH *)calloc(1, sizeof
    (InstanceStruct_HRQ8wXDZJRP84ult25fVAH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_HRQ8wXDZJRP84ult25fVAH);
  ssSetmdlInitializeConditions(S, mdlInitialize_HRQ8wXDZJRP84ult25fVAH);
  ssSetmdlUpdate(S, mdlUpdate_HRQ8wXDZJRP84ult25fVAH);
  ssSetmdlTerminate(S, mdlTerminate_HRQ8wXDZJRP84ult25fVAH);
  ssSetmdlEnable(S, mdlEnable_HRQ8wXDZJRP84ult25fVAH);
  ssSetmdlDisable(S, mdlDisable_HRQ8wXDZJRP84ult25fVAH);
...
static void mdlProcessParameters_HRQ8wXDZJRP84ult25fVAH(SimStruct *S)
{
}

void method_dispatcher_HRQ8wXDZJRP84ult25fVAH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_HRQ8wXDZJRP84ult25fVAH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_HRQ8wXDZJRP84ult25fVAH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_HRQ8wXDZJRP84ult25fVAH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_HRQ8wXDZJRP84ult25fVAH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: HRQ8wXDZJRP84ult25fVAH.\n"
...
mxArray *cgxe_HRQ8wXDZJRP84ult25fVAH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_HRQ8wXDZJRP84ult25fVAH_fallback_info(void)
{
