...
static void cgxe_mdl_start(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S, int_T tid)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S, int_T tid)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S)
{
  InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *moduleInstance =
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF *)calloc(1, sizeof
    (InstanceStruct_hfTj1mRP0WOjF30ZiYFcwF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_hfTj1mRP0WOjF30ZiYFcwF);
  ssSetmdlInitializeConditions(S, mdlInitialize_hfTj1mRP0WOjF30ZiYFcwF);
  ssSetmdlUpdate(S, mdlUpdate_hfTj1mRP0WOjF30ZiYFcwF);
  ssSetmdlTerminate(S, mdlTerminate_hfTj1mRP0WOjF30ZiYFcwF);
  ssSetmdlEnable(S, mdlEnable_hfTj1mRP0WOjF30ZiYFcwF);
  ssSetmdlDisable(S, mdlDisable_hfTj1mRP0WOjF30ZiYFcwF);
...
static void mdlProcessParameters_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S)
{
}

void method_dispatcher_hfTj1mRP0WOjF30ZiYFcwF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_hfTj1mRP0WOjF30ZiYFcwF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_hfTj1mRP0WOjF30ZiYFcwF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_hfTj1mRP0WOjF30ZiYFcwF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_hfTj1mRP0WOjF30ZiYFcwF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: hfTj1mRP0WOjF30ZiYFcwF.\n"
...
mxArray *cgxe_hfTj1mRP0WOjF30ZiYFcwF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_hfTj1mRP0WOjF30ZiYFcwF_fallback_info(void)
{
