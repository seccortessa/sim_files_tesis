...
static void cgxe_mdl_start(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S, int_T tid)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S, int_T tid)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S)
{
  InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *moduleInstance =
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF *)calloc(1, sizeof
    (InstanceStruct_h9GcUCiDzeXoqgqRFi3gSF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_h9GcUCiDzeXoqgqRFi3gSF);
  ssSetmdlInitializeConditions(S, mdlInitialize_h9GcUCiDzeXoqgqRFi3gSF);
  ssSetmdlUpdate(S, mdlUpdate_h9GcUCiDzeXoqgqRFi3gSF);
  ssSetmdlTerminate(S, mdlTerminate_h9GcUCiDzeXoqgqRFi3gSF);
  ssSetmdlEnable(S, mdlEnable_h9GcUCiDzeXoqgqRFi3gSF);
  ssSetmdlDisable(S, mdlDisable_h9GcUCiDzeXoqgqRFi3gSF);
...
static void mdlProcessParameters_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S)
{
}

void method_dispatcher_h9GcUCiDzeXoqgqRFi3gSF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_h9GcUCiDzeXoqgqRFi3gSF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_h9GcUCiDzeXoqgqRFi3gSF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_h9GcUCiDzeXoqgqRFi3gSF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_h9GcUCiDzeXoqgqRFi3gSF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: h9GcUCiDzeXoqgqRFi3gSF.\n"
...
mxArray *cgxe_h9GcUCiDzeXoqgqRFi3gSF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_h9GcUCiDzeXoqgqRFi3gSF_fallback_info(void)
{
