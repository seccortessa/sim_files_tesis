...
static void cgxe_mdl_start(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S, int_T tid)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S, int_T tid)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S)
{
  InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *moduleInstance =
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB *)calloc(1, sizeof
    (InstanceStruct_4gG8jcW7H5QV3KQ7FOK9sB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_4gG8jcW7H5QV3KQ7FOK9sB);
  ssSetmdlInitializeConditions(S, mdlInitialize_4gG8jcW7H5QV3KQ7FOK9sB);
  ssSetmdlUpdate(S, mdlUpdate_4gG8jcW7H5QV3KQ7FOK9sB);
  ssSetmdlTerminate(S, mdlTerminate_4gG8jcW7H5QV3KQ7FOK9sB);
  ssSetmdlEnable(S, mdlEnable_4gG8jcW7H5QV3KQ7FOK9sB);
  ssSetmdlDisable(S, mdlDisable_4gG8jcW7H5QV3KQ7FOK9sB);
...
static void mdlProcessParameters_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S)
{
}

void method_dispatcher_4gG8jcW7H5QV3KQ7FOK9sB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_4gG8jcW7H5QV3KQ7FOK9sB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_4gG8jcW7H5QV3KQ7FOK9sB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_4gG8jcW7H5QV3KQ7FOK9sB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_4gG8jcW7H5QV3KQ7FOK9sB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 4gG8jcW7H5QV3KQ7FOK9sB.\n"
...
mxArray *cgxe_4gG8jcW7H5QV3KQ7FOK9sB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_4gG8jcW7H5QV3KQ7FOK9sB_fallback_info(void)
{
