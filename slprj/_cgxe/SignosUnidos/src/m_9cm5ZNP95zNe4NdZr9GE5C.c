...
static void cgxe_mdl_start(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
...
static void cgxe_mdl_set_sim_state(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S, int_T tid)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S, int_T tid)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
...
static void setSimState_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S)
{
  InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *moduleInstance =
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C *)calloc(1, sizeof
    (InstanceStruct_9cm5ZNP95zNe4NdZr9GE5C));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_9cm5ZNP95zNe4NdZr9GE5C);
  ssSetmdlInitializeConditions(S, mdlInitialize_9cm5ZNP95zNe4NdZr9GE5C);
  ssSetmdlUpdate(S, mdlUpdate_9cm5ZNP95zNe4NdZr9GE5C);
  ssSetmdlTerminate(S, mdlTerminate_9cm5ZNP95zNe4NdZr9GE5C);
  ssSetmdlEnable(S, mdlEnable_9cm5ZNP95zNe4NdZr9GE5C);
  ssSetmdlDisable(S, mdlDisable_9cm5ZNP95zNe4NdZr9GE5C);
...
static void mdlProcessParameters_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S)
{
}

void method_dispatcher_9cm5ZNP95zNe4NdZr9GE5C(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_9cm5ZNP95zNe4NdZr9GE5C(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_9cm5ZNP95zNe4NdZr9GE5C(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_9cm5ZNP95zNe4NdZr9GE5C(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_9cm5ZNP95zNe4NdZr9GE5C(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 9cm5ZNP95zNe4NdZr9GE5C.\n"
...
mxArray *cgxe_9cm5ZNP95zNe4NdZr9GE5C_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_9cm5ZNP95zNe4NdZr9GE5C_fallback_info(void)
{
