  ...
  * data)
{
  ...
  if (ssGetChecksum0(S) == 1293305139 &&
      ssGetChecksum1(S) == 156958220 &&
      ssGetChecksum2(S) == 106888884 &&
      ssGetChecksum3(S) == 2843886952) {
    method_dispatcher_nAgtymYSETBDkPijv7ti1B(S, method, data);
    return 1;
  }
  ...
  if (ssGetChecksum0(S) == 1957879245 &&
      ssGetChecksum1(S) == 2439806734 &&
      ssGetChecksum2(S) == 1531590812 &&
      ssGetChecksum3(S) == 2782816302) {
    method_dispatcher_QAYfRqeuGEcgexoLSTJDb(S, method, data);
    return 1;
  }
