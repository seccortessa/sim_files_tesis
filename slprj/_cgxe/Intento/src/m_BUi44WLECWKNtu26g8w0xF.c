...
#include "m_BUi44WLECWKNtu26g8w0xF.h"
...
static void cgxe_mdl_start(InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_BUi44WLECWKNtu26g8w0xF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_BUi44WLECWKNtu26g8w0xF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_BUi44WLECWKNtu26g8w0xF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_BUi44WLECWKNtu26g8w0xF(SimStruct *S, int_T tid)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_BUi44WLECWKNtu26g8w0xF(SimStruct *S)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_BUi44WLECWKNtu26g8w0xF(SimStruct *S, int_T tid)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_BUi44WLECWKNtu26g8w0xF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_BUi44WLECWKNtu26g8w0xF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_BUi44WLECWKNtu26g8w0xF(SimStruct *S)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_BUi44WLECWKNtu26g8w0xF(SimStruct *S)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_BUi44WLECWKNtu26g8w0xF(SimStruct *S)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_BUi44WLECWKNtu26g8w0xF(SimStruct *S)
{
  InstanceStruct_BUi44WLECWKNtu26g8w0xF *moduleInstance =
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF *)calloc(1, sizeof
    (InstanceStruct_BUi44WLECWKNtu26g8w0xF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_BUi44WLECWKNtu26g8w0xF);
  ssSetmdlInitializeConditions(S, mdlInitialize_BUi44WLECWKNtu26g8w0xF);
  ssSetmdlUpdate(S, mdlUpdate_BUi44WLECWKNtu26g8w0xF);
  ssSetmdlTerminate(S, mdlTerminate_BUi44WLECWKNtu26g8w0xF);
  ssSetmdlEnable(S, mdlEnable_BUi44WLECWKNtu26g8w0xF);
  ssSetmdlDisable(S, mdlDisable_BUi44WLECWKNtu26g8w0xF);
...
static void mdlProcessParameters_BUi44WLECWKNtu26g8w0xF(SimStruct *S)
{
}

void method_dispatcher_BUi44WLECWKNtu26g8w0xF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_BUi44WLECWKNtu26g8w0xF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_BUi44WLECWKNtu26g8w0xF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_BUi44WLECWKNtu26g8w0xF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_BUi44WLECWKNtu26g8w0xF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: BUi44WLECWKNtu26g8w0xF.\n"
...
mxArray *cgxe_BUi44WLECWKNtu26g8w0xF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_BUi44WLECWKNtu26g8w0xF_fallback_info(void)
{
