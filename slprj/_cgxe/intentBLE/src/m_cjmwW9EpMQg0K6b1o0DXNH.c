...
static void cgxe_mdl_start(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S, int_T tid)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S, int_T tid)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S)
{
  InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *moduleInstance =
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH *)calloc(1, sizeof
    (InstanceStruct_cjmwW9EpMQg0K6b1o0DXNH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_cjmwW9EpMQg0K6b1o0DXNH);
  ssSetmdlInitializeConditions(S, mdlInitialize_cjmwW9EpMQg0K6b1o0DXNH);
  ssSetmdlUpdate(S, mdlUpdate_cjmwW9EpMQg0K6b1o0DXNH);
  ssSetmdlTerminate(S, mdlTerminate_cjmwW9EpMQg0K6b1o0DXNH);
  ssSetmdlEnable(S, mdlEnable_cjmwW9EpMQg0K6b1o0DXNH);
  ssSetmdlDisable(S, mdlDisable_cjmwW9EpMQg0K6b1o0DXNH);
...
static void mdlProcessParameters_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S)
{
}

void method_dispatcher_cjmwW9EpMQg0K6b1o0DXNH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_cjmwW9EpMQg0K6b1o0DXNH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_cjmwW9EpMQg0K6b1o0DXNH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_cjmwW9EpMQg0K6b1o0DXNH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_cjmwW9EpMQg0K6b1o0DXNH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: cjmwW9EpMQg0K6b1o0DXNH.\n"
...
mxArray *cgxe_cjmwW9EpMQg0K6b1o0DXNH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_cjmwW9EpMQg0K6b1o0DXNH_fallback_info(void)
{
