...
static void cgxe_mdl_start(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S, int_T tid)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S, int_T tid)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S)
{
  InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *moduleInstance =
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF *)calloc(1, sizeof
    (InstanceStruct_RHDQrIaXNsZ5JtX4Xo2HNF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_RHDQrIaXNsZ5JtX4Xo2HNF);
  ssSetmdlInitializeConditions(S, mdlInitialize_RHDQrIaXNsZ5JtX4Xo2HNF);
  ssSetmdlUpdate(S, mdlUpdate_RHDQrIaXNsZ5JtX4Xo2HNF);
  ssSetmdlTerminate(S, mdlTerminate_RHDQrIaXNsZ5JtX4Xo2HNF);
  ssSetmdlEnable(S, mdlEnable_RHDQrIaXNsZ5JtX4Xo2HNF);
  ssSetmdlDisable(S, mdlDisable_RHDQrIaXNsZ5JtX4Xo2HNF);
...
static void mdlProcessParameters_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S)
{
}

void method_dispatcher_RHDQrIaXNsZ5JtX4Xo2HNF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_RHDQrIaXNsZ5JtX4Xo2HNF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_RHDQrIaXNsZ5JtX4Xo2HNF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_RHDQrIaXNsZ5JtX4Xo2HNF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_RHDQrIaXNsZ5JtX4Xo2HNF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: RHDQrIaXNsZ5JtX4Xo2HNF.\n"
...
mxArray *cgxe_RHDQrIaXNsZ5JtX4Xo2HNF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_RHDQrIaXNsZ5JtX4Xo2HNF_fallback_info(void)
{
