...
static void cgxe_mdl_start(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_MvgkiIuLAQahlZOS1xpPhH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S, int_T tid)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S, int_T tid)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S)
{
  InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *moduleInstance =
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH *)calloc(1, sizeof
    (InstanceStruct_MvgkiIuLAQahlZOS1xpPhH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_MvgkiIuLAQahlZOS1xpPhH);
  ssSetmdlInitializeConditions(S, mdlInitialize_MvgkiIuLAQahlZOS1xpPhH);
  ssSetmdlUpdate(S, mdlUpdate_MvgkiIuLAQahlZOS1xpPhH);
  ssSetmdlTerminate(S, mdlTerminate_MvgkiIuLAQahlZOS1xpPhH);
  ssSetmdlEnable(S, mdlEnable_MvgkiIuLAQahlZOS1xpPhH);
  ssSetmdlDisable(S, mdlDisable_MvgkiIuLAQahlZOS1xpPhH);
...
static void mdlProcessParameters_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S)
{
}

void method_dispatcher_MvgkiIuLAQahlZOS1xpPhH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_MvgkiIuLAQahlZOS1xpPhH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_MvgkiIuLAQahlZOS1xpPhH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_MvgkiIuLAQahlZOS1xpPhH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_MvgkiIuLAQahlZOS1xpPhH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: MvgkiIuLAQahlZOS1xpPhH.\n"
...
mxArray *cgxe_MvgkiIuLAQahlZOS1xpPhH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_MvgkiIuLAQahlZOS1xpPhH_fallback_info(void)
{
