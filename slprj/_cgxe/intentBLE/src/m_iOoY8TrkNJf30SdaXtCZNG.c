...
static void cgxe_mdl_start(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
...
static void mw__internal__call__reset(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance, const emlrtStack *sp);
...
static const mxArray *emlrt_marshallOut(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance);
static void c_emlrt_marshallIn(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
  const emlrtMsgIdentifier *parentId);
static void cgxe_mdl_set_sim_state(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
...
static void init_simulink_io_address(InstanceStruct_iOoY8TrkNJf30SdaXtCZNG
  *moduleInstance);
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (int16_T (*)[3])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S, int_T tid)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S, int_T tid)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S)
{
  InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *moduleInstance =
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG *)calloc(1, sizeof
    (InstanceStruct_iOoY8TrkNJf30SdaXtCZNG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_iOoY8TrkNJf30SdaXtCZNG);
  ssSetmdlInitializeConditions(S, mdlInitialize_iOoY8TrkNJf30SdaXtCZNG);
  ssSetmdlUpdate(S, mdlUpdate_iOoY8TrkNJf30SdaXtCZNG);
  ssSetmdlTerminate(S, mdlTerminate_iOoY8TrkNJf30SdaXtCZNG);
  ssSetmdlEnable(S, mdlEnable_iOoY8TrkNJf30SdaXtCZNG);
  ssSetmdlDisable(S, mdlDisable_iOoY8TrkNJf30SdaXtCZNG);
...
static void mdlProcessParameters_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S)
{
}

void method_dispatcher_iOoY8TrkNJf30SdaXtCZNG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_iOoY8TrkNJf30SdaXtCZNG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_iOoY8TrkNJf30SdaXtCZNG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_iOoY8TrkNJf30SdaXtCZNG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_iOoY8TrkNJf30SdaXtCZNG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: iOoY8TrkNJf30SdaXtCZNG.\n"
...
mxArray *cgxe_iOoY8TrkNJf30SdaXtCZNG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_iOoY8TrkNJf30SdaXtCZNG_fallback_info(void)
{
