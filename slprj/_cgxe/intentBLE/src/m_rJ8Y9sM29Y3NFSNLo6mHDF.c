...
static void cgxe_mdl_start(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S, int_T tid)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S, int_T tid)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S)
{
  InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *moduleInstance =
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF *)calloc(1, sizeof
    (InstanceStruct_rJ8Y9sM29Y3NFSNLo6mHDF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_rJ8Y9sM29Y3NFSNLo6mHDF);
  ssSetmdlInitializeConditions(S, mdlInitialize_rJ8Y9sM29Y3NFSNLo6mHDF);
  ssSetmdlUpdate(S, mdlUpdate_rJ8Y9sM29Y3NFSNLo6mHDF);
  ssSetmdlTerminate(S, mdlTerminate_rJ8Y9sM29Y3NFSNLo6mHDF);
  ssSetmdlEnable(S, mdlEnable_rJ8Y9sM29Y3NFSNLo6mHDF);
  ssSetmdlDisable(S, mdlDisable_rJ8Y9sM29Y3NFSNLo6mHDF);
...
static void mdlProcessParameters_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S)
{
}

void method_dispatcher_rJ8Y9sM29Y3NFSNLo6mHDF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_rJ8Y9sM29Y3NFSNLo6mHDF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_rJ8Y9sM29Y3NFSNLo6mHDF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_rJ8Y9sM29Y3NFSNLo6mHDF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_rJ8Y9sM29Y3NFSNLo6mHDF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: rJ8Y9sM29Y3NFSNLo6mHDF.\n"
...
mxArray *cgxe_rJ8Y9sM29Y3NFSNLo6mHDF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_rJ8Y9sM29Y3NFSNLo6mHDF_fallback_info(void)
{
