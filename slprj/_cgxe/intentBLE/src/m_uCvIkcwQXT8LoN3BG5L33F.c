...
static void cgxe_mdl_start(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
...
static void cgxe_mdl_set_sim_state(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_uCvIkcwQXT8LoN3BG5L33F
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S, int_T tid)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S, int_T tid)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
...
static void setSimState_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S)
{
  InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *moduleInstance =
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F *)calloc(1, sizeof
    (InstanceStruct_uCvIkcwQXT8LoN3BG5L33F));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_uCvIkcwQXT8LoN3BG5L33F);
  ssSetmdlInitializeConditions(S, mdlInitialize_uCvIkcwQXT8LoN3BG5L33F);
  ssSetmdlUpdate(S, mdlUpdate_uCvIkcwQXT8LoN3BG5L33F);
  ssSetmdlTerminate(S, mdlTerminate_uCvIkcwQXT8LoN3BG5L33F);
  ssSetmdlEnable(S, mdlEnable_uCvIkcwQXT8LoN3BG5L33F);
  ssSetmdlDisable(S, mdlDisable_uCvIkcwQXT8LoN3BG5L33F);
...
static void mdlProcessParameters_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S)
{
}

void method_dispatcher_uCvIkcwQXT8LoN3BG5L33F(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_uCvIkcwQXT8LoN3BG5L33F(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_uCvIkcwQXT8LoN3BG5L33F(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_uCvIkcwQXT8LoN3BG5L33F(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_uCvIkcwQXT8LoN3BG5L33F(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: uCvIkcwQXT8LoN3BG5L33F.\n"
...
mxArray *cgxe_uCvIkcwQXT8LoN3BG5L33F_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_uCvIkcwQXT8LoN3BG5L33F_fallback_info(void)
{
