...
static void cgxe_mdl_start(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S, int_T tid)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S, int_T tid)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S)
{
  InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *moduleInstance =
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG *)calloc(1, sizeof
    (InstanceStruct_SeDOQ8l2qZzhyrMZllF0aG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_SeDOQ8l2qZzhyrMZllF0aG);
  ssSetmdlInitializeConditions(S, mdlInitialize_SeDOQ8l2qZzhyrMZllF0aG);
  ssSetmdlUpdate(S, mdlUpdate_SeDOQ8l2qZzhyrMZllF0aG);
  ssSetmdlTerminate(S, mdlTerminate_SeDOQ8l2qZzhyrMZllF0aG);
  ssSetmdlEnable(S, mdlEnable_SeDOQ8l2qZzhyrMZllF0aG);
  ssSetmdlDisable(S, mdlDisable_SeDOQ8l2qZzhyrMZllF0aG);
...
static void mdlProcessParameters_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S)
{
}

void method_dispatcher_SeDOQ8l2qZzhyrMZllF0aG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_SeDOQ8l2qZzhyrMZllF0aG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_SeDOQ8l2qZzhyrMZllF0aG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_SeDOQ8l2qZzhyrMZllF0aG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_SeDOQ8l2qZzhyrMZllF0aG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: SeDOQ8l2qZzhyrMZllF0aG.\n"
...
mxArray *cgxe_SeDOQ8l2qZzhyrMZllF0aG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_SeDOQ8l2qZzhyrMZllF0aG_fallback_info(void)
{
