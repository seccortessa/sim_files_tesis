...
static void cgxe_mdl_start(InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_bLczrvM011dR5REOCr287D
...
static void mw__internal__call__reset(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance, const emlrtStack *sp);
...
static const mxArray *emlrt_marshallOut(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance);
static void c_emlrt_marshallIn(InstanceStruct_bLczrvM011dR5REOCr287D
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
  const emlrtMsgIdentifier *parentId);
static void cgxe_mdl_set_sim_state(InstanceStruct_bLczrvM011dR5REOCr287D
...
static void init_simulink_io_address(InstanceStruct_bLczrvM011dR5REOCr287D
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_bLczrvM011dR5REOCr287D(SimStruct *S, int_T tid)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_bLczrvM011dR5REOCr287D(SimStruct *S)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_bLczrvM011dR5REOCr287D(SimStruct *S, int_T tid)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_bLczrvM011dR5REOCr287D(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
...
static void setSimState_bLczrvM011dR5REOCr287D(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_bLczrvM011dR5REOCr287D(SimStruct *S)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_bLczrvM011dR5REOCr287D(SimStruct *S)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_bLczrvM011dR5REOCr287D(SimStruct *S)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_bLczrvM011dR5REOCr287D(SimStruct *S)
{
  InstanceStruct_bLczrvM011dR5REOCr287D *moduleInstance =
    (InstanceStruct_bLczrvM011dR5REOCr287D *)calloc(1, sizeof
    (InstanceStruct_bLczrvM011dR5REOCr287D));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_bLczrvM011dR5REOCr287D);
  ssSetmdlInitializeConditions(S, mdlInitialize_bLczrvM011dR5REOCr287D);
  ssSetmdlUpdate(S, mdlUpdate_bLczrvM011dR5REOCr287D);
  ssSetmdlTerminate(S, mdlTerminate_bLczrvM011dR5REOCr287D);
  ssSetmdlEnable(S, mdlEnable_bLczrvM011dR5REOCr287D);
  ssSetmdlDisable(S, mdlDisable_bLczrvM011dR5REOCr287D);
...
static void mdlProcessParameters_bLczrvM011dR5REOCr287D(SimStruct *S)
{
}

void method_dispatcher_bLczrvM011dR5REOCr287D(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_bLczrvM011dR5REOCr287D(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_bLczrvM011dR5REOCr287D(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_bLczrvM011dR5REOCr287D(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_bLczrvM011dR5REOCr287D(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: bLczrvM011dR5REOCr287D.\n"
...
mxArray *cgxe_bLczrvM011dR5REOCr287D_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_bLczrvM011dR5REOCr287D_fallback_info(void)
{
