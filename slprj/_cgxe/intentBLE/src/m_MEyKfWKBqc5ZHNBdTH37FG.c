...
static void cgxe_mdl_start(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S, int_T tid)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S, int_T tid)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S)
{
  InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *moduleInstance =
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG *)calloc(1, sizeof
    (InstanceStruct_MEyKfWKBqc5ZHNBdTH37FG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_MEyKfWKBqc5ZHNBdTH37FG);
  ssSetmdlInitializeConditions(S, mdlInitialize_MEyKfWKBqc5ZHNBdTH37FG);
  ssSetmdlUpdate(S, mdlUpdate_MEyKfWKBqc5ZHNBdTH37FG);
  ssSetmdlTerminate(S, mdlTerminate_MEyKfWKBqc5ZHNBdTH37FG);
  ssSetmdlEnable(S, mdlEnable_MEyKfWKBqc5ZHNBdTH37FG);
  ssSetmdlDisable(S, mdlDisable_MEyKfWKBqc5ZHNBdTH37FG);
...
static void mdlProcessParameters_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S)
{
}

void method_dispatcher_MEyKfWKBqc5ZHNBdTH37FG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_MEyKfWKBqc5ZHNBdTH37FG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_MEyKfWKBqc5ZHNBdTH37FG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_MEyKfWKBqc5ZHNBdTH37FG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_MEyKfWKBqc5ZHNBdTH37FG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: MEyKfWKBqc5ZHNBdTH37FG.\n"
...
mxArray *cgxe_MEyKfWKBqc5ZHNBdTH37FG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_MEyKfWKBqc5ZHNBdTH37FG_fallback_info(void)
{
