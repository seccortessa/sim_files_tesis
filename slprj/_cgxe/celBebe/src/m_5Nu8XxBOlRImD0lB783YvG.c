...
static void cgxe_mdl_start(InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_5Nu8XxBOlRImD0lB783YvG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_5Nu8XxBOlRImD0lB783YvG(SimStruct *S, int_T tid)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_5Nu8XxBOlRImD0lB783YvG(SimStruct *S)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_5Nu8XxBOlRImD0lB783YvG(SimStruct *S, int_T tid)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_5Nu8XxBOlRImD0lB783YvG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_5Nu8XxBOlRImD0lB783YvG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_5Nu8XxBOlRImD0lB783YvG(SimStruct *S)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_5Nu8XxBOlRImD0lB783YvG(SimStruct *S)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_5Nu8XxBOlRImD0lB783YvG(SimStruct *S)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_5Nu8XxBOlRImD0lB783YvG(SimStruct *S)
{
  InstanceStruct_5Nu8XxBOlRImD0lB783YvG *moduleInstance =
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG *)calloc(1, sizeof
    (InstanceStruct_5Nu8XxBOlRImD0lB783YvG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_5Nu8XxBOlRImD0lB783YvG);
  ssSetmdlInitializeConditions(S, mdlInitialize_5Nu8XxBOlRImD0lB783YvG);
  ssSetmdlUpdate(S, mdlUpdate_5Nu8XxBOlRImD0lB783YvG);
  ssSetmdlTerminate(S, mdlTerminate_5Nu8XxBOlRImD0lB783YvG);
  ssSetmdlEnable(S, mdlEnable_5Nu8XxBOlRImD0lB783YvG);
  ssSetmdlDisable(S, mdlDisable_5Nu8XxBOlRImD0lB783YvG);
...
static void mdlProcessParameters_5Nu8XxBOlRImD0lB783YvG(SimStruct *S)
{
}

void method_dispatcher_5Nu8XxBOlRImD0lB783YvG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_5Nu8XxBOlRImD0lB783YvG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_5Nu8XxBOlRImD0lB783YvG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_5Nu8XxBOlRImD0lB783YvG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_5Nu8XxBOlRImD0lB783YvG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 5Nu8XxBOlRImD0lB783YvG.\n"
...
mxArray *cgxe_5Nu8XxBOlRImD0lB783YvG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_5Nu8XxBOlRImD0lB783YvG_fallback_info(void)
{
