...
static void cgxe_mdl_start(InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_esq8r6hCXoet8LGnEsjgw
...
static void cgxe_mdl_set_sim_state(InstanceStruct_esq8r6hCXoet8LGnEsjgw
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_esq8r6hCXoet8LGnEsjgw
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_esq8r6hCXoet8LGnEsjgw(SimStruct *S, int_T tid)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_esq8r6hCXoet8LGnEsjgw(SimStruct *S)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_esq8r6hCXoet8LGnEsjgw(SimStruct *S, int_T tid)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_esq8r6hCXoet8LGnEsjgw(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
...
static void setSimState_esq8r6hCXoet8LGnEsjgw(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_esq8r6hCXoet8LGnEsjgw(SimStruct *S)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_esq8r6hCXoet8LGnEsjgw(SimStruct *S)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_esq8r6hCXoet8LGnEsjgw(SimStruct *S)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_esq8r6hCXoet8LGnEsjgw(SimStruct *S)
{
  InstanceStruct_esq8r6hCXoet8LGnEsjgw *moduleInstance =
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw *)calloc(1, sizeof
    (InstanceStruct_esq8r6hCXoet8LGnEsjgw));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_esq8r6hCXoet8LGnEsjgw);
  ssSetmdlInitializeConditions(S, mdlInitialize_esq8r6hCXoet8LGnEsjgw);
  ssSetmdlUpdate(S, mdlUpdate_esq8r6hCXoet8LGnEsjgw);
  ssSetmdlTerminate(S, mdlTerminate_esq8r6hCXoet8LGnEsjgw);
  ssSetmdlEnable(S, mdlEnable_esq8r6hCXoet8LGnEsjgw);
  ssSetmdlDisable(S, mdlDisable_esq8r6hCXoet8LGnEsjgw);
...
static void mdlProcessParameters_esq8r6hCXoet8LGnEsjgw(SimStruct *S)
{
}

void method_dispatcher_esq8r6hCXoet8LGnEsjgw(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_esq8r6hCXoet8LGnEsjgw(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_esq8r6hCXoet8LGnEsjgw(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_esq8r6hCXoet8LGnEsjgw(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_esq8r6hCXoet8LGnEsjgw(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: esq8r6hCXoet8LGnEsjgw.\n"
...
mxArray *cgxe_esq8r6hCXoet8LGnEsjgw_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_esq8r6hCXoet8LGnEsjgw_fallback_info(void)
{
