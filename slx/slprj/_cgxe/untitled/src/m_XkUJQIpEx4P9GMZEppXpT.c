...
static void cgxe_mdl_start(InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_internal_androidTCPSend *obj);
static void mw__internal__call__reset(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance, const emlrtStack *sp, real_T b_u0);
static const mxArray *emlrt_marshallOut(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
...
static void cgxe_mdl_set_sim_state(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
...
static int16_T l_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_XkUJQIpEx4P9GMZEppXpT
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_XkUJQIpEx4P9GMZEppXpT(SimStruct *S, int_T tid)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_XkUJQIpEx4P9GMZEppXpT(SimStruct *S)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_XkUJQIpEx4P9GMZEppXpT(SimStruct *S, int_T tid)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_XkUJQIpEx4P9GMZEppXpT(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
...
static void setSimState_XkUJQIpEx4P9GMZEppXpT(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_XkUJQIpEx4P9GMZEppXpT(SimStruct *S)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_XkUJQIpEx4P9GMZEppXpT(SimStruct *S)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_XkUJQIpEx4P9GMZEppXpT(SimStruct *S)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_XkUJQIpEx4P9GMZEppXpT(SimStruct *S)
{
  InstanceStruct_XkUJQIpEx4P9GMZEppXpT *moduleInstance =
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT *)calloc(1, sizeof
    (InstanceStruct_XkUJQIpEx4P9GMZEppXpT));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_XkUJQIpEx4P9GMZEppXpT);
  ssSetmdlInitializeConditions(S, mdlInitialize_XkUJQIpEx4P9GMZEppXpT);
  ssSetmdlUpdate(S, mdlUpdate_XkUJQIpEx4P9GMZEppXpT);
  ssSetmdlTerminate(S, mdlTerminate_XkUJQIpEx4P9GMZEppXpT);
  ssSetmdlEnable(S, mdlEnable_XkUJQIpEx4P9GMZEppXpT);
  ssSetmdlDisable(S, mdlDisable_XkUJQIpEx4P9GMZEppXpT);
...
static void mdlProcessParameters_XkUJQIpEx4P9GMZEppXpT(SimStruct *S)
{
}

void method_dispatcher_XkUJQIpEx4P9GMZEppXpT(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_XkUJQIpEx4P9GMZEppXpT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_XkUJQIpEx4P9GMZEppXpT(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_XkUJQIpEx4P9GMZEppXpT(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_XkUJQIpEx4P9GMZEppXpT(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: XkUJQIpEx4P9GMZEppXpT.\n"
...
mxArray *cgxe_XkUJQIpEx4P9GMZEppXpT_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_XkUJQIpEx4P9GMZEppXpT_fallback_info(void)
{
